# 10.02. Системы мониторинга — Алексей Храпов
...
- Pull (сервер собирает данные за счет собственных ресурсов)
    ...
    - Возможность получения данных по http (упрощение отладки данных)
    - Возможность использования TLS для защиты передаваемых данных

    Минусы:
    - Нет возможности получения данных за NAT'ом без "проброса" портов
    - Использование HTTP over TCP (нагрузка при сборе и обработке данных выше, чем при использовании протокола UDP)
