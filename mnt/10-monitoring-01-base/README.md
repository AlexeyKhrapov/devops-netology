...
Я бы предложил выделить ключевые метрики для SLI и выводить на панель системы мониторинга их соотвтетствие SLO c выделением цветом. Также можно выводить количественные несоответствия продукта SLO и их длительность за определенные временные промежутки.
