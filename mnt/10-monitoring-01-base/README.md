...
Я бы ещё раз уточнил обязанности перед клиентом в SLA (если их нет, то предложил изложить, на примере метрик [ответа на задание 1](#ответ)), на основании SLA и реальных возможностей обозначить SLO (метрики и их критические значения, которые не должны достигаться), например. SLI будет показывать фактические метрики, на их основании уже можно будет судить о том, насколько мы выполняем свои обязанности перед клиентами и какое качество обслуживания.
